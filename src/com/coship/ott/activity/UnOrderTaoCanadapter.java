...
public class UnOrderTaoCanadapter extends BaseAdapter {
	private final static String TAG = "UnOrderTaoCanadapter";
	...
	public UnOrderTaoCanadapter(Context mContext,
			List<ProductInfo> unorderProductInfos, String name, String CardNum) {
		super();
		this.mContext = mContext;
		this.mDate = unorderProductInfos;
		this.userName = name;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holdView.unsubscribe.setText("立即订购");
		holdView.unsubscribe.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(mContext, UnOrderActivity.class);
	...
	static class ViewHole {
		...
		private static Button unsubscribe;
